...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            setTimeout(function() {
                // Create mailto link
                const mailtoLink = `mailto:info@feinmetallwerk.de?subject=${encodeURIComponent(formData.subject || 'Anfrage von Website')}&body=${encodeURIComponent(
                    `Name: ${formData.name}\n` +
...
(function() {
    ...
    // Layihəyə klik
    document.querySelectorAll('.project-item[data-gallery]').forEach(item => {
        item.addEventListener('click', function() {
            const translateKey = this.querySelector('[data-translate]').getAttribute('data-translate');
const title = (typeof translations !== 'undefined' && typeof currentLanguage !== 'undefined' && translations[currentLanguage] && translations[currentLanguage][translateKey])
    ? translations[currentLanguage][translateKey]
